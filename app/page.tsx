    ...
    <section className="relative overflow-hidden border border-[#cad7e8] bg-[#f7faff] p-5 sm:p-7" aria-labelledby="research-snapshot-title">
      ...
      <div className="mt-6 divide-y divide-[#dbe4ef]">
        <article className="pb-6">
          ...
          <h3 className="mt-2 text-base font-semibold leading-5 text-[#0b2a5b]">Outcome Reporting, Healthcare Resource Use and Economic Evidence in People with Vasospastic Angina</h3>
          <p className="mt-2 text-xs font-semibold text-[#54708f]">A Systematic Review and Meta-analysis</p>
        ...
        <article className="pt-6">
          ...
          <p className="mt-2 text-xs font-semibold text-[#54708f]">A Systematic Review</p>
          <dl className="mt-5 grid grid-cols-2 gap-x-4 gap-y-4">
